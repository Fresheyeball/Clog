  ...
  Clog = (function() {
    ...
    Clog.prototype._bail = function() {
      ...
      if (!this.__bailed && this._logIndex >= this._MAX_LOG) {
        ...
        if (this._console.image) {
          ...
          this._console.image(gameOverGifs[_.random(0, gameOverGifs.length - 1)]);
    ...
    Clog.prototype.test = function() {
      ...
      if (!this._bail()) {
        ...
        meta = meta.split(',');
        meta = _.map(meta, function(d) {
          return d.trim().replace('this.', '@');
        });
        res = {};
    ...
    Clog.prototype._andrew = function(memeTwo, logMessage) {
      return this.meme("hey developer", memeTwo, "http://i.imgur.com/aQ3wwGi.jpg", logMessage);
    };
    ...
    Clog.prototype.keanu = function(isBig) {
      ...
      if (!this._bail()) {
        if (this._console.image && !_.isString(isBig)) {
          if (isBig) {
    ...
    Clog.prototype.arnold = function(color) {
      ...
      if (!this._bail()) {
        if (this._console.image && !color) {
          this._console.image(arnoldIMG[_.random(arnoldIMG.length - 1)]);
